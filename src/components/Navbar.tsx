    ...
    >
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/domicilio"
            className="rounded-2xl border border-line/60 px-4 py-2 text-sm font-bold text-fg hover:bg-fg/5 transition"
            aria-label="Ordenar a domicilio"
          >
            Ordenar a domicilio
          </Link>
          <a
            ...
            className="rounded-2xl bg-accent px-4 py-2 text-sm font-bold text-bg hover:drop-shadow-glow transition"
        ...
        {/* LADO DERECHO EN MÓVIL: CTA + hamburguesa */}
        <div className="flex items-center gap-2 md:hidden">
          {/* CTA móvil SIEMPRE visible */}
          <Link
            href="/domicilio"
            className="rounded-xl bg-accent px-3 py-1.5 text-xs font-bold text-bg"
            aria-label="Ordenar a domicilio"
            onClick={close}
          >
            Ordenar a Domicilio
        ...
        <div className="md:hidden">
          ...
          <div className="fixed right-0 top-0 z-50 h-dvh w-80 max-w-[82%] border-l border-line/60 bg-card p-5 shadow-xl">
            ...
            <div className="mt-6 border-t border-line/60 pt-5 space-y-3">
              <Link
                href="/domicilio"
                className="inline-flex w-full items-center justify-center rounded-xl border border-line/60 px-4 py-3 font-bold text-fg hover:bg-fg/5"
                onClick={close}
                aria-label="Ordenar a domicilio"
              >
                Ordenar a domicilio
